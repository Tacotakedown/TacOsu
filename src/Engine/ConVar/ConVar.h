...
public:
	//we indulge in some contructors
	...
	explicit ConVar(UString name, ConVarCallbackArgs callback);
	...
	void setCallback(NativeConVarCallback calback);
