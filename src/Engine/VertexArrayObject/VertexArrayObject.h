...
public:
	...
	const std::vector<Vector3>& getVerticies() const { return m_verticies; }
	...
	inline unsigned int getNumVerticies() const { return m_iNumVerticies; }
